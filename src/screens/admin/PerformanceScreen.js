  ...
  return (
    <SafeAreaView edges={['top']} style={styles.container}>
      ...
      <View style={styles.header}>
		...
		<TouchableOpacity style={styles.logout} activeOpacity={0.8} onPress={()=>{navigation.navigate('Login')}}>
          <Ionicons name="log-out" size={22} color={colors.textPrimary} />
        </TouchableOpacity>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {/* Monthly Task Progress Card */}
        <View style={styles.monthlyTaskCard}>
          <View style={styles.monthlyTaskHeader}>
            <AppText style={styles.monthlyTaskTitle}>Monthly Task</AppText>
            <AppText style={styles.monthlyTaskPercentage}>85%</AppText>
          </View>
          <AppText style={styles.monthlyTaskDelta}>+0,75%</AppText>
          ...
          <View style={styles.monthsContainer}>
            {['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'].map((month) => (
              <AppText key={month} style={styles.monthText}>{month}</AppText>
            ))}
          </View>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  areaShape: {
    ...
    height: '65%',
    backgroundColor: 'rgba(23,167,115,0.25)',
  ...
  // New styles for Monthly Task card
  monthlyTaskCard: {
    marginTop: 14,
    backgroundColor: colors.card,
    borderRadius: CARD_RADIUS,
